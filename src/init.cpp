...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 7777 or testnet: 16999)") + "\n" +
...
// FBX irc
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8697 or testnet: 8697)") + "\n" +
